...
This project is indexed by GitNexus as **culler** (2049 symbols, 4552 relationships, 177 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
